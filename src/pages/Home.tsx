  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-5 py-14 md:px-8 md:py-20">
        ...
        <section aria-label="Principais notícias">
        ...
        <section aria-label="Destaques secundários" className="mt-20">
        ...
        <section aria-label="Sobre esta edição" className="mt-20 border-t border-[var(--color-line)] pt-14">
          <motion.div
          ...
          >
            ...
            <p className="mt-4 font-editorial text-xl italic leading-relaxed text-[var(--color-ink-soft)] md:text-2xl">
              Esta edição especial acompanha, dia após dia, as sessões do
              Tribunal Militar Internacional de Nuremberg, um episódio que
              redefiniria os limites da justiça entre nações.
            </p>
          </motion.div>
